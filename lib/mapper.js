...
exports.identify = function(msg, settings){
  ...
  ret.custom_attributes = formatNested(ret.custom_attributes, blacklisted);
...
exports.track = function(track, settings){
  ...
  var properties = formatNested(formatMetadata(track.properties()), blacklisted);
  if (revenue) {
    var revenueData = {
...
exports.group = function(msg, settings) {
  ...
  var companyData = reject({
    ...
    custom_attributes: formatNested(customTraits, blacklisted)
  });
  ...
  if (is.string(company)){
    ...
    each(function(company){
      ...
      var payload = reject({
        ...
        plan: company.plan,
        custom_attributes: formatNested(customTraits, settings.blacklisted),
...
function formatNested(obj, blacklisted){
  return foldl(function(attrs, value, key){
    ...
    if (trait === 'stringify') {
      ...
      attrs = extend(flatten(pair), attrs);
    }
