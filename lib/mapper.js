...
exports.identify = function(msg){
  ...
  // Represents the user's unsubscribed status: https://developers.intercom.io/docs/create-or-update-user
  if (traits.unsubscribedFromEmails) {
    ret.unsubscribed_from_emails = true;
    delete traits["unsubscribedFromEmails"]
  }
