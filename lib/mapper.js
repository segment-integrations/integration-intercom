...
exports.identify = function(msg, settings){
  ...
  var blacklisted = settings.blacklist || {};
  ...
  // However, due to customer demand, we will allow you to blacklist properties/traits that you'd rather stringify or drop rather than flatten
  ret.custom_attributes = foldl(function(attrs, value, key){
    ...
    if (trait === 'stringify') {
      ...
      attrs = extend(flatten(obj), attrs);
    }

    return attrs;
  }, {}, ret.custom_attributes);
