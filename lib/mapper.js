...
function formatNested(obj, settings){
  ...
  //combine all traits
  return extend(stringifiedTraits, flattenedTraits, formattedTraits.nonNestedTraits);
...
//       if (defaultMethod === 'stringify' && typeof(value) === 'string') {
//         attrs[key] = value;
//       } else {
//         attrs[key] = JSON.stringify(value);
//       }
//       console.log(attrs);
//       if (defaultMethod === 'flatten') attrs = extend(flatten(pair), attrs);
//     }  
//     return attrs; 
//   }, { flatten: {}, drop: {}, stringify: {}, defaultMethod: {} }, obj);
// }
